...
const char HTTP_ROOT_MAIN[]        PROGMEM = "<h1>{v}</h1><h3>Autores: Arthur, Aline, Claiver e Wanderley</h3>";
const char * const HTTP_PORTAL_MENU[] PROGMEM = {
"<form action='/abrirFechar'    method='get'><button>ABRIR/FECHAR A PORTA</button></form><br/>\n", // ABRIR
...
const char R_abrirFechar[]        PROGMEM = "/abrirFechar";
